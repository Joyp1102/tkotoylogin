...
class _LoginSignupPageState extends State<LoginSignupPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(children: [
        // === Cream gradient background with brand bubbles ===
        Container(
        ...
        Positioned(left: -100, top: -80, child: _bubble(240, tkoOrange.withOpacity(.14))),
        Positioned(right: -80, bottom: -60, child: _bubble(200, tkoTeal.withOpacity(.10))),
              ...
              child: Container(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Row(children: const [
                    ...
                    SizedBox(width: 8),
                    Text('or email', style: TextStyle(color: Colors.black54)),
                    SizedBox(width: 8),
                    Expanded(child: Divider()),
                  ]),
                    ...
                    child: TabBarView(controller: _tab, children: [
                      ...
                      Column(children: [
                        Row(children: [
                          Expanded(
                              child:
                              _Field(label: 'First name', controller: firstName)),
                          const SizedBox(width: 10),
                          Expanded(
                              child:
                              _Field(label: 'Last name', controller: lastName)),
                        ]),
                        const SizedBox(height: 10),
                        _Field(
                            label: 'Email',
                  ...
                  const SizedBox(height: 8),
                  Text('By continuing you agree to TKO’s Terms & Privacy.',
